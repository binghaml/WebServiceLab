...
import com.example.levi.webservicelab.CourseListFragment.OnListFragmentInteractionListener;
...
public class MyCourseListRecyclerViewAdapter extends RecyclerView.Adapter<MyCourseListRecyclerViewAdapter.ViewHolder> {
    ...
    public MyCourseListRecyclerViewAdapter(List<Course> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
